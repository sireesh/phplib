...
class mysql_db {
    ...
    */
    ...
    final public static function getInstance() {
        if ( is_null(mobi_db::$dbInstance) ) {
            mobi_db::$dbInstance = new mobi_db( mobi_db::$dParams['host'],
		    mobi_db::$dParams['user'],
		    mobi_db::$dParams['password'],
		    mobi_db::$dParams['database']
            );
        }
        return mobi_db::$dbInstance;
    }
